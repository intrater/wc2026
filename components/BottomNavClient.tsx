...
export function BottomNavClient({ items }: { items: BottomNavItem[] }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-md items-stretch justify-around rounded-[25px] border border-white/15 bg-background/15 px-2 py-1 shadow-2xl backdrop-blur-lg">
        {items.map((item) => {
